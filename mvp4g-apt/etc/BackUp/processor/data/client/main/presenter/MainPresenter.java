...
import com.mvp4g.processor.data.client.main.MainEventFilter;
import com.mvp4g.processor.data.client.main.view.MainView;
...
public class MainPresenter
  ...
  public void bind() {
    ...
    view.getBroadcastInfo()
        .addClickHandler(new ClickHandler() {

          @Override
          public void onClick(ClickEvent event) {
            eventBus.broadcastInfo(new String[]{"Info" + infoCount++,
                                                "Info" + infoCount++});
          }
  ...
  public void preLoad(MainEventBus eventBus,
                      ...
                      Object[] params,
                      Command load) {
    if (view.getCompanyModuleFilter()
            .getValue()) {
      if (eventName != null) {
